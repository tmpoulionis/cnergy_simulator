    ...
    protected void setup() {
        ...
        addBehaviour(new TickerBehaviour(this, 1000) {
            ...
            protected void onTick() {
                if (timeToken.equals("NIGHT")) {
                        production = 0.0; // No production at night
                    } else {
                        if (solarToken.equals("SUNNY")) {
                            production = installedCapacityMW * 1.0; // Full output
                        } else if (solarToken.equals("CLOUDY")) {
                            production = installedCapacityMW * 0.4; // reduced output
                        } else {
                            production = 0.0;
                        }
                    }
